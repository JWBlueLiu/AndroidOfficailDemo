...
public class AlarmService extends Activity {
    ...
    private OnClickListener mStartAlarmListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            am.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, firstTime, 30 * 1000,
                mAlarmSender);

            // Tell the user about what we did.
            Toast.makeText(AlarmService.this, R.string.repeating_scheduled, Toast.LENGTH_LONG)
                .show();
        }
    };
    ...
    private OnClickListener mStopAlarmListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            // Tell the user about what we did.
            Toast.makeText(AlarmService.this, R.string.repeating_unscheduled, Toast.LENGTH_LONG)
                .show();
        }
    };
}
