...
public class GameView extends View {
    ...
    static void setPaintARGBBlend(Paint paint, float alpha, int a1, int r1, int g1, int b1, int a2,
        int r2, int g2, int b2) {
        paint.setARGB(blend(alpha, a1, a2), blend(alpha, r1, r2), blend(alpha, g1, g2),
            blend(alpha, b1, b2));
    }
    ...
    private abstract class Sprite {
        ...
        public boolean collidesWith(Sprite other) {
            ...
            return !mDestroyed
                && !other.mDestroyed
                && distanceTo(other)
                <= Math.max(mSize, other.mSize) + Math.min(mSize, other.mSize) * 0.5f;
        }
        ...
        protected boolean isOutsidePlayfield() {
            ...
            return mPositionX < 0 || mPositionX >= width || mPositionY < 0 || mPositionY >= height;
        }
    ...
    private class Ship extends Sprite {
        ...
        @Override public boolean step(float tau) {
            if (!super.step(tau)) {
                return false;
            }
        ...
        public void draw(Canvas canvas) {
            setPaintARGBBlend(mPaint, mDestroyAnimProgress, 255, 63, 255, 63, 0, 255, 0, 0);
        ...
        @Override public float getDestroyAnimDuration() {
            return 1.0f;
        }
    ...
    private class Bullet extends Sprite {
        ...
        public void draw(Canvas canvas) {
            setPaintARGBBlend(mPaint, mDestroyAnimProgress, 255, 255, 255, 0, 0, 255, 255, 255);
    ...
    private class Obstacle extends Sprite {
        ...
        public void draw(Canvas canvas) {
            setPaintARGBBlend(mPaint, mDestroyAnimProgress, 255, 127, 127, 255, 0, 255, 0, 0);
            canvas.drawCircle(mPositionX, mPositionY, mSize * (1.0f - mDestroyAnimProgress),
                mPaint);
        }
