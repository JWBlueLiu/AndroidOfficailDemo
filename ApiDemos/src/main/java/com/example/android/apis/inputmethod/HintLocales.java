...
public class HintLocales extends Activity {
     ...
     * @see LocaleList
     */
    @NonNull private EditText createEditTextWithImeHintLocales(@Nullable LocaleList hintLocales) {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        layout.addView(
            createEditTextWithImeHintLocales(LocaleList.forLanguageTags("en-GB,en-US,en")));
        ...
        // subtags.
        layout.addView(
            createEditTextWithImeHintLocales(LocaleList.forLanguageTags("ryu-Kana-JP-x-android")));
