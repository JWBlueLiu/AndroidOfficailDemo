...
public class ShadowCardStack extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < max; i++) {
            ...
            Animator rotateAway =
                ObjectAnimator.ofFloat(card, "rotationY", i == 0 ? 0 : ROTATE_DEGREES);
        ...
        totalSet.playSequentially(createSet(expandAnimators, 250), createSet(towardAnimators, 0),

            createSet(moveAwayAnimators, 250), createSet(moveBackAnimators, 0),

            createSet(awayAnimators, 250), createSet(collapseAnimators, 0));
        totalSet.start();
