...
public class DeviceAdminSample extends PreferenceActivity {
        ...
        protected void reloadSummaries() {
            if (mSetPassword != null) {
                if (mAdminActive) {
                    ...
                    mSetPassword.setSummary(
                        sufficient ? R.string.password_sufficient : R.string.password_insufficient);
                } else {
    ...
    public static class GeneralFragment extends AdminSampleFragment
        ...
        @Override public void onCreate(Bundle savedInstanceState) {
            ...
            mTrustAgentComponent = (EditTextPreference) findPreference(KEY_TRUST_AGENT_COMPONENT);
            mTrustAgentComponent.setOnPreferenceChangeListener(this);

            mTrustAgentFeatures = (EditTextPreference) findPreference(KEY_TRUST_AGENT_FEATURES);
        ...
        @Override protected void reloadSummaries() {
            super.reloadSummaries();
            String cameraSummary = getString(
                mDPM.getCameraDisabled(mDeviceAdminSample) ? R.string.camera_disabled
            ...
            String keyguardSecureCameraSummary = getString(
                (disabled & DevicePolicyManager.KEYGUARD_DISABLE_SECURE_CAMERA) != 0
                    ? R.string.keyguard_secure_camera_disabled
    ...
    public static class ExpirationFragment extends AdminSampleFragment
        ...
        @Override protected void reloadSummaries() {
            ...
            mExpirationTimeout.setSummary(
                localGlobalSummary(localLong / MS_PER_MINUTE, globalLong / MS_PER_MINUTE));
                        ...
                        builder.setPositiveButton(R.string.wipe_warning_second_ok,
                            new DialogInterface.OnClickListener() {
                                @Override public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (stillActive) {
                                        mDPM.wipeData(
                                            wipeAllData ? DevicePolicyManager.WIPE_EXTERNAL_STORAGE
                                                : 0);
                                    }
                                }
                            });
    ...
    public static class DeviceAdminSampleReceiver extends DeviceAdminReceiver {
        ...
        @Override public void onPasswordExpiring(Context context, Intent intent) {
            ...
            String message = context.getString(
                expired ? R.string.expiration_status_past : R.string.expiration_status_future);
