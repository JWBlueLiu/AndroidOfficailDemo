...
public class ChangedContacts extends Activity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private CursorLoader getChangeLoader() {
        String[] projection = new String[] {
            ...
            ContactsContract.Data.DISPLAY_NAME, ContactsContract.Data.CONTACT_LAST_UPDATED_TIMESTAMP
        };
        ...
        return new CursorLoader(this, ContactsContract.Data.CONTENT_URI, projection, selection,
            bindArgs, ContactsContract.Data.CONTACT_LAST_UPDATED_TIMESTAMP
            + " desc, "
    ...
    private static class ChangeAdapter extends CursorAdapter {
        ...
        @Override public void bindView(View view, Context context, Cursor cursor) {
            ...
            String timestamp = cursor.getString(
                cursor.getColumnIndex(ContactsContract.Data.CONTACT_LAST_UPDATED_TIMESTAMP));
