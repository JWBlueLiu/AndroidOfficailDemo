...
public class ExpandableList2 extends ExpandableListActivity {
    ...
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MyExpandableListAdapter(this, android.R.layout.simple_expandable_list_item_1,
            android.R.layout.simple_expandable_list_item_1, new String[] { Contacts.DISPLAY_NAME },
            // Name for group layouts
            new int[] { android.R.id.text1 }, new String[] { Phone.NUMBER },
