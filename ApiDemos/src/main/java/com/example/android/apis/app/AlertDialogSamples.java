    ...
    @Override protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DIALOG_YES_NO_MESSAGE:
                return new AlertDialog.Builder(AlertDialogSamples.this).setTitle(
            ...
            case DIALOG_YES_NO_OLD_SCHOOL_MESSAGE:
                return new AlertDialog.Builder(AlertDialogSamples.this,
                    AlertDialog.THEME_TRADITIONAL).setIconAttribute(android.R.attr.alertDialogIcon)
            ...
            case DIALOG_YES_NO_HOLO_LIGHT_MESSAGE:
                return new AlertDialog.Builder(AlertDialogSamples.this,
                    AlertDialog.THEME_HOLO_LIGHT).setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(R.string.alert_dialog_two_buttons_title)
                    .setPositiveButton(R.string.alert_dialog_ok,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
            ...
            case DIALOG_YES_NO_DEFAULT_LIGHT_MESSAGE:
                return new AlertDialog.Builder(AlertDialogSamples.this,
                    AlertDialog.THEME_DEVICE_DEFAULT_LIGHT).setTitle(
                    R.string.alert_dialog_two_buttons_title)
                    .setPositiveButton(R.string.alert_dialog_ok,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
            ...
            case DIALOG_YES_NO_DEFAULT_DARK_MESSAGE:
                return new AlertDialog.Builder(AlertDialogSamples.this,
                    AlertDialog.THEME_DEVICE_DEFAULT_DARK).setTitle(
                    R.string.alert_dialog_two_buttons_title)
                    .setPositiveButton(R.string.alert_dialog_ok,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
            ...
            case DIALOG_YES_NO_LONG_MESSAGE:
                return new AlertDialog.Builder(AlertDialogSamples.this).setTitle(
                    R.string.alert_dialog_two_buttons_msg)
            ...
            case DIALOG_SINGLE_CHOICE:
                return new AlertDialog.Builder(AlertDialogSamples.this).setTitle(
                    R.string.alert_dialog_single_choice)
            ...
            case DIALOG_MULTIPLE_CHOICE:
                return new AlertDialog.Builder(AlertDialogSamples.this).setTitle(
                    R.string.alert_dialog_multi_choice)
            ...
            case DIALOG_MULTIPLE_CHOICE_CURSOR:
                ...
                Cursor cursor =
                    managedQuery(ContactsContract.Contacts.CONTENT_URI, projection, null, null,
                        null);
                return new AlertDialog.Builder(AlertDialogSamples.this).setTitle(
                    R.string.alert_dialog_multi_choice_cursor)
