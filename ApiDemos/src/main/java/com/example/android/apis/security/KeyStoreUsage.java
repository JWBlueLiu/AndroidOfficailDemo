...
public class KeyStoreUsage extends Activity {
    ...
    private class UpdateKeyListTask extends AsyncTask<Void, Void, Enumeration<String>> {
        @Override protected Enumeration<String> doInBackground(Void... params) {
            try {
                // BEGIN_INCLUDE(list)
                /*
        ...
        @Override protected void onPostExecute(Enumeration<String> result) {
        ...
        @Override protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                kpg.initialize(new KeyGenParameterSpec.Builder(alias,
                    ...
                    KeyProperties.DIGEST_SHA256, KeyProperties.DIGEST_SHA512).build());
