...
public class ForegroundService extends Service {
    ...
    void handleCommand(Intent intent) {
        if (ACTION_FOREGROUND.equals(intent.getAction()) || ACTION_FOREGROUND_WAKELOCK.equals(
            intent.getAction())) {
            ...
            Notification notification = new Notification.Builder(this).setSmallIcon(
        ...
        if (ACTION_FOREGROUND_WAKELOCK.equals(intent.getAction())
            ...
            if (mWakeLock == null) {
                mWakeLock =
                    getSystemService(PowerManager.class).newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                        "wake-service");
                mWakeLock.acquire();
            } else {
                releaseWakeLock();
