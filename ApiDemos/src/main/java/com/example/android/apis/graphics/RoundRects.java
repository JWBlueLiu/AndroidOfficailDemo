...
public class RoundRects extends GraphicsActivity {
    ...
    private static class SampleView extends View {
        ...
        public SampleView(Context context) {
            ...
            mDrawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[] {
        ...
        static void setCornerRadii(GradientDrawable drawable, float r0, float r1, float r2,
            float r3) {
