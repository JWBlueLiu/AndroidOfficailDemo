...
public class AutoComplete6 extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter =
            new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, COUNTRIES);
    ...
    static final String[] COUNTRIES = new String[] {
        ...
        "Brunei", "Bulgaria", "Burkina Faso", "Burundi", "Cote d'Ivoire", "Cambodia", "Cameroon",
        ...
        "North Korea", "Northern Marianas", "Norway", "Oman", "Pakistan", "Palau", "Panama",
        ...
        "Venezuela", "Vietnam", "Wallis and Futuna", "Western Sahara", "Yemen", "Yugoslavia",
        "Zambia", "Zimbabwe"
    };
}
