...
public class CubeMapActivity extends Activity {
    ...
    private class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            if (mContextSupportsCubeMap) {
                ...
                gl11ep.glTexGeni(GL11ExtensionPack.GL_TEXTURE_GEN_STR,
                    GL11ExtensionPack.GL_TEXTURE_GEN_MODE, GL11ExtensionPack.GL_REFLECTION_MAP);
                checkGLError(gl);
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            if (mContextSupportsCubeMap) {
                int[] cubeMapResourceIds = new int[] {
                    R.raw.skycubemap0, R.raw.skycubemap1, R.raw.skycubemap2, R.raw.skycubemap3,
                    R.raw.skycubemap4, R.raw.skycubemap5
                };
        ...
        private int generateCubeMap(GL10 gl, int[] resourceIds) {
            ...
            gl.glTexParameterf(GL11ExtensionPack.GL_TEXTURE_CUBE_MAP, GL10.GL_TEXTURE_MIN_FILTER,
                GL10.GL_LINEAR);
            gl.glTexParameterf(GL11ExtensionPack.GL_TEXTURE_CUBE_MAP, GL10.GL_TEXTURE_MAG_FILTER,
                GL10.GL_LINEAR);
            ...
            for (int face = 0; face < 6; face++) {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.e("CubeMap",
                            "Could not decode texture for face " + Integer.toString(face));
                    }
                }
        ...
        private Grid generateTorusGrid(GL gl, int uSteps, int vSteps, float majorRadius,
            float minorRadius) {
    ...
    private static class Grid {
        ...
        public void createBufferObjects(GL gl) {
            ...
            gl11.glBufferData(GL11.GL_ARRAY_BUFFER, mVertexByteBuffer.capacity(), mVertexByteBuffer,
                GL11.GL_STATIC_DRAW);

            gl11.glBindBuffer(GL11.GL_ELEMENT_ARRAY_BUFFER, mElementBufferObjectId);
            mIndexBuffer.position(0);
            gl11.glBufferData(GL11.GL_ELEMENT_ARRAY_BUFFER, mIndexBuffer.capacity() * CHAR_SIZE,
