...
public class NotifyingService extends Service {
    ...
    private void showNotification(int moodId, int textId) {
        ...
        PendingIntent contentIntent =
            PendingIntent.getActivity(this, 0, new Intent(this, NotifyingController.class), 0);
        ...
        Notification notification = new Notification.Builder(this).setSmallIcon(moodId)
