...
public class BitmapPixels extends GraphicsActivity {
    ...
    private static class SampleView extends View {
        ...
        private static void makeRamp(int from, int to, int n, int[] ramp8888, short[] ramp565,
            short[] ramp4444) {
        ...
        public SampleView(Context context) {
            ...
            makeRamp(premultiplyColor(Color.RED), premultiplyColor(Color.GREEN), N, data8888,
                data565, data4444);
