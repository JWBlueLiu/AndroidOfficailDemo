...
public class PresentationActivity extends Activity
    ...
    private void showPresentation(Display display, DemoPresentationContents contents) {
        ...
        Log.d(TAG,
            "Showing presentation photo #" + contents.photo + " on display #" + displayId + ".");
    ...
    @Override public void onClick(View v) {
        ...
        AlertDialog alert = builder.setTitle(
            r.getString(R.string.presentation_alert_info_text, display.getDisplayId()))
    ...
    private final class DisplayListAdapter extends ArrayAdapter<Display> {
        ...
        @Override public View getView(int position, View convertView, ViewGroup parent) {
            ...
            DemoPresentationContents contents =
                presentation != null ? presentation.mContents : null;
            if (contents == null) {
            ...
            if (contents == null || modes.length == 1) {
                ...
                for (Display.Mode mode : modes) {
                    modeAdapter.add(String.format("Mode %d: %dx%d/%.1ffps", mode.getModeId(),
    ...
    private final class DemoPresentation extends Presentation {
        ...
        @Override protected void onCreate(Bundle savedInstanceState) {
            ...
            text.setText(
                r.getString(R.string.presentation_photo_text, photo, displayId, display.getName()));
    ...
    private final static class DemoPresentationContents implements Parcelable {
        ...
        public static final Creator<DemoPresentationContents> CREATOR =
            new Creator<DemoPresentationContents>() {
                @Override public DemoPresentationContents createFromParcel(Parcel in) {
                    return new DemoPresentationContents(in);
                }

                @Override public DemoPresentationContents[] newArray(int size) {
