...
public class InternalSelectionFocus extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        final InternalSelectionView middleColumn =
            new InternalSelectionView(this, 5, "middle column");
        middleColumn.setLayoutParams(params);
        middleColumn.setPadding(10, 10, 10, 10);
        layout.addView(middleColumn);

        final InternalSelectionView rightColumn =
            new InternalSelectionView(this, 5, "right column");
