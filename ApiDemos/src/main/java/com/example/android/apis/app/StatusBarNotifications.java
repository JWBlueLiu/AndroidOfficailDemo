...
public class StatusBarNotifications extends Activity {
    ...
    private PendingIntent makeDefaultIntent() {
        ...
        intents[0] = Intent.makeRestartActivityTask(
            new ComponentName(this, com.example.android.apis.ApiDemos.class));
    ...
    private void setDefault(int defaults) {
        ...
        mNotificationManager.notify(MOOD_NOTIFICATIONS, // we use a string id because it is a unique
