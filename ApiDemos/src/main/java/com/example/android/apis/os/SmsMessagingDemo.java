...
public class SmsMessagingDemo extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra(SMS_RECIPIENT_EXTRA)) {
            ((TextView) findViewById(R.id.sms_recipient)).setText(
                getIntent().getExtras().getString(SMS_RECIPIENT_EXTRA));
        ...
        final EditText recipientTextEdit =
            (EditText) SmsMessagingDemo.this.findViewById(R.id.sms_recipient);
        final EditText contentTextEdit =
            (EditText) SmsMessagingDemo.this.findViewById(R.id.sms_content);
            ...
            public void onClick(View v) {
                ...
                for (String message : messages) {
                    sms.sendTextMessage(recipient, null, message,
                        PendingIntent.getBroadcast(SmsMessagingDemo.this, 0,
